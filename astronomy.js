...
const deepSkyObjects = [
    ...
    },
    {
        ...
        size: "1.4' × 1.0'",
        equipment: "Telescope",
        image: "https://storage.noirlab.edu/media/archives/images/screen/noao-m57.jpg",
        imageCredit: "NOIRLab/NSF/AURA",
        links: {
    ...
    },
    {
        ...
        size: "8.0' × 5.7'",
        equipment: "Binoculars / Telescope",
        image: "https://cdn.eso.org/images/screen/eso9846a.jpg",
        imageCredit: "ESO",
        links: {
    ...
    },
    {
        ...
        image: "https://storage.noirlab.edu/media/archives/images/screen/noao-n7000mosblock.jpg",
        imageCredit: "NOIRLab/NSF/AURA",
        links: {
    ...
    },
    {
        ...
        image: "https://storage.noirlab.edu/media/archives/images/screen/noao-veilkeller.jpg",
        imageCredit: "NOIRLab/NSF/AURA",
        links: {
    ...
    },
    {
        ...
        size: "20'",
        equipment: "Binoculars / Telescope",
        image: "https://storage.noirlab.edu/media/archives/images/screen/noao0103a.jpg",
        imageCredit: "NOIRLab/NSF/AURA",
        links: {
    ...
    },
    {
        ...
        size: "18'",
        equipment: "Binoculars / Telescope",
        image: "https://storage.noirlab.edu/media/archives/images/screen/noao0159a.jpg",
        imageCredit: "NOIRLab/NSF/AURA",
        links: {
    ...
    },
    {
        ...
        size: "60'",
        equipment: "Naked eye / Binoculars",
        image: "./images/double-cluster.jpg",
    ...
    },
    {
        ...
        size: "13'",
        equipment: "Binoculars / Telescope",
        image: "https://storage.noirlab.edu/media/archives/images/screen/noao-02464.jpg",
        imageCredit: "NOIRLab/NSF/AURA",
        links: {
    ...
    },
    {
        ...
        size: "14'",
        equipment: "Binoculars / Telescope",
        image: "https://storage.noirlab.edu/media/archives/images/screen/noao-m92.jpg",
        imageCredit: "NOIRLab/NSF/AURA",
        links: {
...
function openModal(index) {
    // Get object from either deepSkyObjects or planets array
    let obj;
    if (index < deepSkyObjects.length) {
        obj = deepSkyObjects[index];
    } else {
        const planetIndex = index - deepSkyObjects.length;
        obj = planets[planetIndex];
    }
    if (!obj) return;
    ...
    modalTitle.textContent = `${obj.name} (${obj.catalog || 'Planet'})`;
